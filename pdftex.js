var encode_utf8 = function (s) { return unescape(encodeURIComponent(s)); }
var decode_utf8 = function (s) { return decodeURIComponent(escape(s));   }
...
var TeXLive = function(opt_workerPath) {
  ...
  var component = function(workerPath) {
    ...
    self.on_stdout = function(msg) {  console.log(msg);  }

    self.on_stderr = function(msg) {  console.log(msg);  }
  ...
  pdftex.run = function(source_code) {
    ...
    if(self.initialized)
      ...
      commands = [
        curry(self, 'FS_createDataFile', ['/', 'input.tex', encode_utf8(source_code), true, true]),
    ...
    var sendCompile = function() {
      ...
      return self.sendCommand({
        'command': 'run',
        //'arguments': ['-interaction=nonstopmode','&pdflatex', 'input.tex'],
        'arguments': ['-interaction=nonstopmode','&input', 'input.tex'],
 ...
 var determineChunkSize = function() {
    ...
    curry = function(o,f,a) {return function(){return o[f].apply(o,a);}
  }
